...
val Icons.Android: ImageVector by lazy {
    icon(name = "Android", viewportWidth = 95.0f, viewportHeight = 95.0f) {
        iconGroup(
            ...
            iconPath(fill = SolidColor(Color(0xFF8BD8A0)), fillAlpha = 0.6f, strokeAlpha = 0.6f) {
                // M 7.96 58.97
            ...
            iconPath(fill = SolidColor(Color(0xFF8BD8A0)), fillAlpha = 0.5f, strokeAlpha = 0.5f) {
                // M 86.59 58.97
            ...
            iconPath(fill = SolidColor(Color(0xFF202124)), fillAlpha = 0.1f, strokeAlpha = 0.1f) {
                // M 28.66 41.06
            ...
            iconPath(fill = SolidColor(Color(0xFFFFFFFF)), fillAlpha = 0.3f, strokeAlpha = 0.3f) {
                // M 27.5 30.13
            ...
            iconPath(fill = SolidColor(Color(0xFF81C995)), fillAlpha = 0.3f, strokeAlpha = 0.3f) {
                // M 62.87 38.13

...
val Brasil: ImageVector
    get() {
        ...
        return ImageVector.Builder(
            name = ".Brasil",
            defaultWidth = 720.0.dp,
            defaultHeight = 504.0.dp,
            viewportWidth = 4200.0f,
            viewportHeight = 2940.0f,
        ).apply {
            brasilChunk1()
            brasilChunk2()
        }.build().also { _brasil = it }
    }
...
private var _brasil: ImageVector? = null

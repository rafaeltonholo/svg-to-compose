...
val Android: ImageVector
    get() {
        ...
        return ImageVector.Builder(
            ...
            group(
                // M85.122 64.795 a38.463 38.463 0 0 0 -3.26 -8.647 38.68 38.68 0 0 0 -9.074 -11.447 38.79 38.79 0 0 0 -4.813 -3.542 c0.016 -0.024 0.029 -0.05 0.044 -0.075 0.776 -1.341 1.555 -2.68 2.331 -4.022 l2.28 -3.928 1.636 -2.822 a3.543 3.543 0 0 0 -1.251 -4.816 3.569 3.569 0 0 0 -2.173 -0.478 3.535 3.535 0 0 0 -2.698 1.743 l-1.636 2.822 -2.279 3.928 c-0.776 1.341 -1.555 2.68 -2.332 4.022 l-0.255 0.44 c-0.118 -0.046 -0.234 -0.093 -0.353 -0.138 a38.633 38.633 0 0 0 -13.786 -2.525 c-0.133 0 -0.265 0 -0.398 0.002 a38.652 38.652 0 0 0 -12.338 2.14 c-0.449 0.156 -0.891 0.321 -1.33 0.494 l-0.239 -0.411 c-0.776 -1.341 -1.555 -2.68 -2.331 -4.022 a136999.438 136999.438 0 0 0 -3.916 -6.75 3.534 3.534 0 0 0 -3.364 -1.748 3.517 3.517 0 0 0 -1.506 0.484 3.526 3.526 0 0 0 -1.61 2.13 3.542 3.542 0 0 0 0.359 2.685 l1.636 2.822 2.28 3.928 c0.776 1.341 1.554 2.68 2.331 4.022 l0.019 0.034 a38.894 38.894 0 0 0 -11.142 10.451 38.38 38.38 0 0 0 -2.81 4.581 38.494 38.494 0 0 0 -3.26 8.647 c-0.65 2.647 1.496 5.025 4.223 5.025 H80.89 c2.727 0 4.88 -2.38 4.231 -5.03Z
                ...
                // M7.96 58.972 c-3.13 9.844 -4.74 18.118 -3.599 18.48 1.142 0.364 4.604 -7.322 7.733 -17.166 3.13 -9.844 16.037 -20.578 14.896 -20.94 -1.142 -0.364 -15.9 9.782 -19.03 19.626Z
                path(
                ...
                // M86.587 58.972 c3.13 9.844 4.74 18.118 3.6 18.48 -1.143 0.364 -4.605 -7.322 -7.734 -17.166 -3.13 -9.844 -16.037 -20.578 -14.895 -20.94 1.141 -0.364 15.9 9.782 19.029 19.626Z
                path(
                    fill = SolidColor(Color(0xFF8BD8A0)),
                    fillAlpha = 0.5f,
                ) {
                ...
                // M28.66 41.056 c0.37 -0.242 -1.586 -3.891 -4.37 -8.15 -2.785 -4.26 -5.343 -7.516 -5.713 -7.274 -0.37 0.242 1.587 3.891 4.371 8.15 2.785 4.26 5.342 7.516 5.713 7.274Z
                path(
                ...
                // M27.507 30.127 c3.242 5.324 4.823 7.764 5.183 7.544 0.36 -0.219 -0.637 -3.014 -3.88 -8.338 -3.124 -7.111 -8.762 -2.87 -8.205 -2.093 1.083 2.085 2.757 -4.578 6.902 2.887Z
                path(
                ...
                // M18.478 28.284 c0.585 2.02 2.987 3.1 5.364 2.412 2.378 -0.688 3.831 -2.884 3.246 -4.905 -0.585 -2.02 -2.986 -3.1 -5.364 -2.412 -2.377 0.688 -3.83 2.884 -3.246 4.904Z
                path(
                    fill = Brush.radialGradient(
                ...
                // M67.644 28.508 c0.585 2.02 2.987 3.1 5.364 2.413 2.378 -0.688 3.831 -2.884 3.246 -4.905 -0.585 -2.02 -2.986 -3.1 -5.364 -2.412 -2.377 0.688 -3.83 2.884 -3.246 4.904Z
                path(
                    fill = Brush.radialGradient(
                        0.0f to Color(0xFFFFFFFF),
                        0.948f to Color(0x00FFFFFF),
                ...
                // M66.116 41.32 c-0.374 -0.236 1.524 -3.917 4.24 -8.22 2.715 -4.304 5.22 -7.601 5.594 -7.365 0.374 0.236 -1.524 3.916 -4.24 8.22 -2.715 4.303 -5.22 7.6 -5.594 7.365Z
                path(
                    fill = SolidColor(Color(0xFF202124)),
                    fillAlpha = 0.1f,
                ) {
                ...
                group(
                    // M68.333 41.39 c-1.824 -1.138 -5.988 -3.09 -7.843 -3.925 l1.226 -4.336 11.974 4.818 c-1.026 1.621 -3.533 4.58 -5.357 3.443Z
                    clipPathData = PathData {
                        // M 68.333 41.39
                    ...
                    // M62.868 38.127 c-0.91 -0.447 -1.717 -0.665 -1.804 -0.487 -0.087 0.177 0.594 0.558 1.503 1.004 0.909 0.447 1.701 0.79 1.788 0.613 0.087 -0.177 -0.579 -0.683 -1.487 -1.13Z
                    path(
                ...
                group(
                    // M26.241 41.743 c1.8 -1.175 5.924 -3.213 7.76 -4.085 l-1.314 -4.31 -11.872 5.063 c1.058 1.6 3.626 4.507 5.426 3.332Z
                    clipPathData = PathData {
                        // M 26.241 41.743
                    ...
                    // M31.637 38.373 c0.899 -0.465 1.702 -0.7 1.793 -0.524 0.09 0.176 -0.583 0.57 -1.482 1.036 -0.9 0.465 -1.685 0.825 -1.776 0.649 -0.09 -0.176 0.565 -0.695 1.465 -1.16Z
                    path(
                        fill = SolidColor(Color(0xFF81C995)),
                        fillAlpha = 0.3f,
                    ) {
                ...
                // M67.451 30.41 c-3.032 5.252 -4.52 7.657 -4.903 7.436 -0.383 -0.221 0.484 -2.985 3.516 -8.237 3.456 -9.124 10.306 -7.918 9.182 -2.931 -0.886 2.05 -3.956 -3.634 -7.795 3.732Z
                path(
                    fill = SolidColor(Color(0xFFFFFFFF)),
                    fillAlpha = 0.3f,
                ) {
            ...
            // M31.736 55.797 c0.466 -0.528 0.073 -1.649 -0.878 -2.504 -0.95 -0.855 -2.1 -1.12 -2.565 -0.592 -0.466 0.527 -0.073 1.648 0.878 2.503 0.95 0.855 2.1 1.12 2.566 0.593Z
            path(
                fill = Brush.radialGradient(
            ...
            // M64.413 54.447 c0.951 -0.855 1.344 -1.976 0.878 -2.503 -0.466 -0.528 -1.614 -0.263 -2.565 0.592 -0.951 0.855 -1.344 1.976 -0.878 2.503 0.466 0.528 1.614 0.263 2.565 -0.592Z
            path(
                fill = Brush.radialGradient(
                    0.0f to Color(0xFF93E19F),
                    1.0f to Color(0x0093E19F),
            ...
            // M32.363 58.497 c1.153 -2.88 -0.058 -4.654 -0.807 -5.207 -2.162 -2.675 -5.074 -0.61 -5.938 0.553 -0.865 1.134 -2.133 3.17 -0.894 5.962 1.24 2.793 6.198 2.298 7.639 -1.308Z M62.253 58.561 c-1.153 -2.85 0.058 -4.653 0.807 -5.177 2.162 -2.676 5.073 -0.61 5.938 0.553 0.865 1.134 2.133 3.17 0.894 5.933 -1.24 2.763 -6.197 2.298 -7.639 -1.28 v-0.029Z
            path(
            ...
            // M68.77 60.532 c1.787 -1.192 2.075 -3.956 0.634 -6.137 -1.441 -2.181 -4.064 -2.967 -5.852 -1.774 -1.787 1.192 -2.075 3.955 -0.634 6.137 1.441 2.181 4.065 2.967 5.852 1.774Z
            path(
                fill = SolidColor(Color(0xFF202124)),
            ) {
                // M 68.77 60.532
            ...
            // M31.674 58.666 c1.441 -2.181 1.182 -4.886 -0.577 -6.078 -1.758 -1.164 -4.323 -0.35 -5.765 1.803 -1.44 2.181 -1.181 4.886 0.577 6.079 1.758 1.163 4.324 0.349 5.765 -1.804Z M62.922 58.702 c-1.441 -2.182 -1.182 -4.887 0.577 -6.08 1.758 -1.163 4.324 -0.348 5.765 1.804 1.441 2.181 1.182 4.886 -0.577 6.079 -1.758 1.163 -4.323 0.349 -5.765 -1.803Z
            path(
            ...
            // M32.18 54.41 c-0.83 -2.338 -2.776 -2.363 -3.645 -2.094 0.736 -0.43 2.159 -0.144 2.835 0.485 0.517 0.5 0.776 1.292 0.842 1.636 l-0.032 -0.026Z
            path(
                fill = Brush.linearGradient(
            ...
            // M65.173 52.508 c-2.047 0.116 -2.71 1.745 -2.796 2.53 0.202 -0.494 0.951 -1.512 2.248 -1.774 1.297 -0.232 2.998 1.251 3.69 2.036 l0.634 -0.727 c-0.403 -0.756 -1.73 -2.21 -3.776 -2.065Z
            path(
                fill = Brush.linearGradient(
            ...
            // M68.744 54.193 c1.384 1.687 1.528 3.694 1.355 4.538 0.346 -1.658 0.23 -3.258 -1.096 -4.887 -0.72 -0.901 -1.844 -1.396 -2.651 -1.629 -0.116 -0.029 -0.26 -0.058 -0.346 -0.087 a1.929 1.929 0 0 0 -0.49 -0.087 c0.144 0.03 0.317 0.058 0.49 0.087 0.115 0 0.23 0.058 0.346 0.087 0.576 0.204 1.354 0.64 2.42 1.978 h-0.028Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 68.744 54.193
            ...
            // M27.658 53.506 c-0.808 0.174 -1.413 1.018 -1.586 1.425 l0.404 0.61 s0.288 -0.494 0.605 -0.814 c0.317 -0.32 0.807 -0.668 1.009 -0.814 l-0.404 -0.407 h-0.028Z M66.956 53.525 c0.779 0.146 1.384 0.96 1.586 1.367 l-0.404 0.582 s-0.288 -0.465 -0.605 -0.785 -0.779 -0.64 -0.98 -0.785 l0.403 -0.379Z
            path(
            ...
            // M30.947 57.86 c-0.375 0.203 -0.98 0.494 -1.24 0.61 l-0.23 0.698 a3.781 3.781 0 0 0 1.21 -0.698 l0.26 -0.61Z M32.154 54.802 a4.56 4.56 0 0 0 -0.23 -0.61 v0.261 c0.115 0.204 0.202 0.582 0.23 0.756 0 -0.058 0.058 -0.232 0 -0.436 v0.03Z
            path(
                fill = SolidColor(Color(0xFFE2DCE1)),
                fillAlpha = 0.8f,
                strokeAlpha = 0.8f,
            ...
            // M63.588 57.922 c0.375 0.204 0.98 0.494 1.24 0.61 l0.23 0.699 a3.782 3.782 0 0 1 -1.21 -0.698 l-0.26 -0.611Z M62.403 54.865 a4.56 4.56 0 0 1 0.23 -0.611 v0.262 c-0.115 0.203 -0.202 0.581 -0.23 0.756 0 -0.058 -0.058 -0.233 0 -0.436 v0.029Z
            path(
                fill = SolidColor(Color(0xFFE2DCE1)),
                fillAlpha = 0.8f,
                strokeAlpha = 0.8f,

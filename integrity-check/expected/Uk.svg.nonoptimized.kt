    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 0.0f, y = 0.0f)
                // L 300 300
                lineTo(x = 300.0f, y = 300.0f)
                // M 300 0
                moveTo(x = 300.0f, y = 0.0f)
                // L 0 300
            ...
            // M150 150  v-30  L30 0  H0z h30  L300 30  V0z v30  L270 300  H300z h-30  L0 270  V300z
            path(
                ...
                verticalLineToRelative(dy = 30.0f)
                // L 270 300
                lineTo(x = 270.0f, y = 300.0f)
                // H 300z
                horizontalLineTo(x = 300.0f)
                close()
                // h -30
                horizontalLineToRelative(dx = -30.0f)
                // L 0 270

 ...
 * @property collectedImports Mutable set of fully qualified imports accumulated during resolution.
...
class TemplateContext(
    ...
    val collectedImports: MutableSet<String> = mutableSetOf(),
     ...
     * import is registered in [collectedImports].
     *
    ...
    companion object {
        ...
        fun forIcon(
            ...
            return TemplateContext(
                ...
                definitions = defs,
                fragments = frags,
                collectedImports = contents.imports.toMutableSet(),
                colorMappings = config.definitions.colorMapping,
            ).also { ctx ->
                config.definitions.receiver?.let { receiver ->
                    ctx.collectedImports.add("${receiver.packageName}.${receiver.name}")
                }
            }
        }

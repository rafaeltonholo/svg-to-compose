...
sealed interface Value : CssComponentValueNode {
     ...
     */
    data class Color(override val location: CssLocation, val value: kotlin.String) : Value {
     ...
     */
    data class String(override val location: CssLocation, val value: kotlin.String) : Value {
        override fun toString(indent: Int): kotlin.String = "'$value'"
    }
     ...
     */
    data class Identifier(override val location: CssLocation, val name: kotlin.String) : Value {
     ...
     */
    data class Number(override val location: CssLocation, val value: kotlin.String) : Value {
        override fun toString(indent: Int): kotlin.String = value
    }
     ...
     */
    data class Percentage(override val location: CssLocation, val value: kotlin.String) : Value {
        override fun toString(indent: Int): kotlin.String = "$value%"
    }
     ...
     */
    data class Url(override val location: CssLocation, val value: kotlin.String) : Value {
        override fun toString(indent: Int): kotlin.String {

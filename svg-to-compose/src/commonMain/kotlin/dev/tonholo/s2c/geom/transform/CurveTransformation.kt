...
import dev.tonholo.s2c.geom.combineWith
...
internal data object CurveTransformation : PathTransformation<PathNodes.CurveTo>() {
    override fun PathNodes.CurveTo.applyTransformation(
        ...
        val args = if (isRelative) {
            ...
            start[0] = cursor[0]
            start[1] = cursor[1]
            transformRelativePoint(transformation.matrix, x1, y1) coordinatesWith
                transformRelativePoint(transformation.matrix, x2, y2) combineWith
            ...
            start[0] = cursor[0]
            start[1] = cursor[1]
            transformAbsolutePoint(transformation.matrix, x1, y1) coordinatesWith
                transformAbsolutePoint(transformation.matrix, x2, y2) combineWith

...
internal sealed class PathTransformation<T : PathNodes> {
    ...
    protected fun transformAbsolutePoint(
    ...
    protected fun transformRelativePoint(
        matrix: Array<out DoubleArray>,
        x: Double,
        y: Double,
    ): Point2D {
    ...
    fun PathNodes.new(args: List<Any>, command: PathCommand? = null): PathNodes =
        pathNode(command ?: this.command) {
            args(args)
